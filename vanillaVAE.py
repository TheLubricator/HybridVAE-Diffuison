...
class VAEEncoder(nn.Module):
    def __init__(self, in_channels=1, latent_channels=4):  # Changed from 3 to 1
        super().__init__()
...
class VAEDecoder(nn.Module):
    def __init__(self, latent_channels=4, out_channels=1):  # Changed from 3 to 1
        super().__init__()
        ...
        self.final = nn.Conv2d(32, out_channels, kernel_size=3, padding=1)  # Changed to 1
